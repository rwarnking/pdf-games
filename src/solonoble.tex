...
%%%%%%%%%% Solutions %%%%%%%%%%
%var solString = "ex,lj,ck,Pf,DP,GI,JH,mG,GI,ik,gi,LJ,JH,Hl,lj,jh,CK,pF,AC,CK,Mg,gi,ac,ck,kI,dp,pF,FD,DP,Pp,ox";
%var solString = "ex,lj,xe/hj,Ki,jh/ai,ca,fd,hj,ai,jh/MK,gM,hL,Fp,MK,pF/CK,DF,AC,JL,CK,LJ/PD,GI,mG,JH,GI,DP/Ox";
var solMoves = [
...
function jumpAnimation(x1, y1, x2, y2, x3, y3) {
    ...
    if (timestep >= 1.0) {
        ...
        if (getAllMoves().length > 0) {
            ...
            if (currentMarbleCount == 1 && complField[W_POS][W_POS][0] == FULL) {
 ...
 * in character-notation. It is possible to give any
 * number of moves.
 */
function executeMoves() {
    ...
    if (fieldIdx > 1) {
        printInfoText("Cant execute moves for the selected layout!");
        return;
    }
        ...
        \begin{multicols}{2}
            ...
            \PushButton[name=exmoves, bordercolor=, backgroundcolor=, borderwidth=0]{
                \begin{tcolorbox}
                    \centering
                    Execute moves: \strut{}
                    \TextField[name=exmovestxt, bordercolor=gray, borderwidth=2pt, backgroundcolor=white]{\strut}
                \end{tcolorbox}
            }\vspace{0.1cm}
            ...
            \PushButton[name=import, bordercolor=, backgroundcolor=, borderwidth=0]{
                \begin{tcolorbox}
                    \centering
                    Import field: \strut{}
                    \TextField[name=importtxt, bordercolor=gray, borderwidth=2pt, backgroundcolor=white]{\strut}
                \end{tcolorbox}
            }%
            ...
            \begin{tcolorbox}
                \TextField[name=info, width=2\linewidth, bordercolor=, backgroundcolor=, readonly]{\strut}
            \end{tcolorbox}
            ...
            \PushButton[name=export, bordercolor=, backgroundcolor=, borderwidth=0]{
                \begin{tcolorbox}
                    \centering
                    Export field: \strut{}
                    \TextField[name=exporttxt, bordercolor=gray, borderwidth=2pt, backgroundcolor=white]{\strut}
                \end{tcolorbox}
            }
