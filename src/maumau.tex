...
const PLAYER_POS = [
    [CANVAS_LTRB[LEFT], CANVAS_LTRB[BOT] + CARD_WIDTH],
    [CANVAS_LTRB[LEFT] + CARD_WIDTH, CANVAS_CENTER_H],
    [CANVAS_CENTER_W, CANVAS_LTRB[TOP] - CARD_WIDTH],
    [CANVAS_LTRB[RIGHT] - CARD_WIDTH, CANVAS_CENTER_H]
]
...
function redrawPlayerCards(pIdx) {
    ...
    var perCardH = CANVAS_HEIGHT / playerCards[pIdx].length;
    var perCardW = CANVAS_WIDTH / playerCards[pIdx].length;
