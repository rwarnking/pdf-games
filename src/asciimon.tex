...
function initialize() {
    ...
    % Initialize the player and enemy creature
...
function initializeButtons() {
    ...
    % Assign each button the corresponding function
    ...
    printInfoText("Initialized the game. Beat the current enemy creature.");
}
...
function restart() {
    ...
    % Initialize the player items to empty
...
function hint() {
    if (this.getField("cmHint").isBoxChecked(0)) {
        ...
        % height 842, width 596
        % upper-left x, upper-left y, lower-right x and lower-right y
        % Use the restart button rect to get the upper bound for this rect
        var helper = this.getField("restart");
        field.rect = [298, helper.rect[3], 595, 0];
        field.delay = false;
    }
}
...
function change(idx) {
    ...
    if (oldName == "Empty") {
        animatedString = "You switched to " + creature[NAME] + ".";
    } else {
...
function airParticles(target) {
    ...
    particleSys.move = function(p) {
        ...
        if (p == leader) {
            ...
            % If the leader is already out of bounds
...
\begin{document}
    ...
    \begin{Form}
        ...
        \columnbreak
            ...
            \begin{flushright}%
                \TextField[name=hintbox,%
                    bordercolor=white, backgroundcolor=white, readonly]{}
        ...
        % Calculate the max height of a line

        \def\lineHeight{\dimexpr (0.2955\paperheight)/\boardCharsH \relax}
        \def\lineWidth{\dimexpr (0.2955\paperheight) \relax}
        ...
        \begin{multicols}{2}
            ...
            \begin{center}
                \xintFor* #1 in {\xintSeq{0}{\boardCharsH-1}} \do {%
                    \TextField[%
                        name=player#1, width=\lineWidth, height=\lineHeight,%
        ...
        \columnbreak%
            ...
            \begin{center}
                \xintFor* #1 in {\xintSeq{0}{\boardCharsH-1}} \do {%
                    \TextField[%
                        name=enemy#1, width=\lineWidth, height=\lineHeight,%
                        bordercolor=, backgroundcolor=, readonly%
                    ]{}%
                    \\[0pt]%
                }%
