...
function initialiseButtons() {
    ...
    for (var m = 0; m < BOARD_CHARS_H; m++) {
        ...
        cell.textSize = SCREEN_TEXT_WIDTH / BOARD_CHARS_W;
...
function defaultParticleSys() {
    particles = Array.apply(null, Array(ATK_ANIM_CELLS)).map(_ => [
        ...
        (SCREEN_TEXT_WIDTH / BOARD_CHARS_W) * 1.3 % SIZE
    ]);
...
function stoneParticles(target) {
    ...
    particleSys.emit = function(p) {
        ...
        particles[p][SIZE] = (SCREEN_TEXT_WIDTH / BOARD_CHARS_W) * 0.9;
...
function fluffParticles(target) {
    ...
    particleSys.emit = function(p) {
        particles[p][WIDTH] = (canvas.halfHeight / BOARD_CHARS_H) * 2.0;
        particles[p][HEIGHT] = (canvas.halfHeight / BOARD_CHARS_H) * 2.0;
        particles[p][SIZE] = (SCREEN_TEXT_WIDTH / BOARD_CHARS_W) / 3.0;
...
function standardParticles(target) {
    ...
    particleSys.emit = function(p) {
        particles[p][WIDTH] = (canvas.halfHeight / BOARD_CHARS_H) * 2.0;
        particles[p][HEIGHT] = (canvas.halfHeight / BOARD_CHARS_H) * 2.0;
        particles[p][SIZE] = (SCREEN_TEXT_WIDTH / BOARD_CHARS_W) * 2.0;
...
\begin{document}
    ...
    \begin{Form}
            ...
            \begin{center}
                \xintFor* #1 in {\xintSeq{0}{\boardCharsH-1}} \do {%
                    \TextField[%
                        ...
                        bordercolor=white, name=player#1, readonly%
                    ]{}%
                    \\[0pt]%
                }%
            \end{center}
        ...
        \columnbreak%
            ...
            \begin{center}
                \xintFor* #1 in {\xintSeq{0}{\boardCharsH-1}} \do {%
                    \TextField[%
                        width=\blocksizeW, height=\blocksizeH,%
                        bordercolor=white, name=enemy#1, readonly%
                    ]{}%
                    \\[0pt]%
                }%
            \end{center}
        ...
        \begin{center}
            \begin{tcolorbox}
                \TextField[name=info, bordercolor=, backgroundcolor=, width=\linewidth, readonly]{}
            \end{tcolorbox}

            % Game related buttons
            \begin{tabularx}{\textwidth}{@{} *{2}{X} @{}}%
                \PushButton[name=button1, bordercolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                ...
                \PushButton[name=button2, bordercolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                ...
                \PushButton[name=button3, bordercolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                ...
                \PushButton[name=button4, bordercolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                ...
                \PushButton[name=back, bordercolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                        Back\strut
                    \end{tcolorbox}
        ...
        \begin{multicols}{2}
            ...
            \xintFor* #1 in {\xintSeq{0}{\atkAnimCells-1}} \do {%
                \TextField[%
                    name=atkanim#1, bordercolor=, backgroundcolor=,
                    borderwidth=0pt, readonly, hidden
                ]{}%
            }%
