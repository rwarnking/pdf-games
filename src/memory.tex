...
const GAME_DESC = "In this game multiple player compete to get the most pair.\
...
After the reveal both are hidden again if they do not math or they are remove if they do.\
