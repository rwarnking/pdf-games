...
function place(m, n) {
    if (complField[m][n] == FULL) {
        printInfoText("Move this stone!");
        return;
    }
...
\begin{document}
    ...
    \begin{Form}
        ...
        % The cells for the field
        \xintFor* #1 in {\xintSeq{0}{\rows-1}} \do {%
            \xintFor* #2 in {\xintSeq{0}{\columns-1}} \do {%
                \TextField[name=cell#1-#2, backgroundcolor=, bordercolor=gray,
