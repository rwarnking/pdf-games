...
\begin{document}
    ...
    \begin{Form}
        ...
        \def\blocksizeH{\dimexpr (500 pt -\resultH pt) / (\boardHeight * 5) \relax}
                    ...
                    \xintFor* #1 in {\xintSeq{0}{\boardWidth-1}} \do {%
                        \PushButton[name=pos#1-#2, bordercolor=, backgroundcolor=, borderwidth=0]{%
                            \begin{tcolorbox}%
                                ...
                                \TextField[name=field0#1#2, height=\blocksizeH,%
                                    bordercolor=, backgroundcolor=, readonly]{}\\[2pt]%
                                \TextField[name=field1#1#2, height=\blocksizeH,%
                                    bordercolor=, backgroundcolor=, readonly]{}\\[2pt]%
                                \TextField[name=field2#1#2, height=\blocksizeH,%
                                    bordercolor=, backgroundcolor=, readonly]{}\\[2pt]%
                                \TextField[name=field3#1#2, height=\blocksizeH,%
                                    bordercolor=, backgroundcolor=, readonly]{}\\[2pt]%
                                \TextField[name=field4#1#2, height=\blocksizeH,%
