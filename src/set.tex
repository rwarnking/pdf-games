...
function markField(x, y) {
    ...
    if (isSet(lastSelections)) {
        ...
        if (gameOverCheck()) {
            printInfoText("The game is over, there are no further sets to be found.");
            gameover = true;
        }
    } else {
 ...
 * @return true if is a set false else.
 */
 ...
 * TODO this is not totally correct since it does not check all cards
 * but rather the cards that are on the field.
 */
...
function draw(x, y) {
    ...
    var positions = posList[cardList[idx][3] - 1];
                    ...
                    \xintFor* #1 in {\xintSeq{0}{\fieldWidth-1}} \do {%
                        \PushButton[name=pos#1#2, bordercolor=white]{%
                            \begin{tcolorbox}%
                                ...
                                \TextField[%
                                    height=\blocksizeH,%
                                    bordercolor=white, name=field0#1#2, readonly=true]{}\\[0.5mm]%
                                \TextField[%
                                    height=\blocksizeH,%
                                    bordercolor=white, name=field1#1#2, readonly=true]{}\\[0.5mm]%
                                \TextField[%
                                    height=\blocksizeH,%
                                    bordercolor=white, name=field2#1#2,  readonly=true]{}\\[0.5mm]%
                                \TextField[%
                                    height=\blocksizeH,%
                                    bordercolor=white, name=field3#1#2,  readonly=true]{}\\[0.5mm]%
                                \TextField[%
                                    height=\blocksizeH,%
            ...
            \begin{tabularx}{\textwidth}{@{} *{\playerCount}{X} @{}}%
                \xintFor* #1 in {\xintSeq{1}{\playerCount}} \do {%
                    \PushButton[name=player#1, bordercolor=white]{
                        \begin{tcolorbox}
                            \centering
                            \TextField[name=points#1, height=0.35cm, width=0.5cm, readonly=true]{Player #1:}
                        \end{tcolorbox}
                    }
                    % Have the cell divider for all elements
                    % that are not the last one
