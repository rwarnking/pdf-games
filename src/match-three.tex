...
% Break twice background color
const BK2_BG_COLOR = [ "G", 0.5 ];
% Bomb background color
const BOMB_BG_COLOR = [ "RGB", 0.984, 0.0, 0.0 ];
% Unbreakable background color
const UBK_BG_COLOR = [ "G", 0.0 ];
% Obstacle background color
const OBS_BG_COLOR = [ "G", 0.75 ];
    ...
    \subsection*{Levelmodifier}
        ...
        \begin{center}
            ...
            \begin{tabularx}{\textwidth}{@{} s X t @{}}%
                ...
                D,U,R,G,M\\%
                \CheckBox[name=cbObstacle, bordercolor=gray, checkboxsymbol=5, bordersep=0]{Obstacle} &%
                Cell without content and unmatchable/unmoveable. &
                U%
            \end{tabularx}
        \end{center}

        D = removeable, U = unmoveable, R = respanable, G = gravity, M = matchable
