...
\begin{document}
    ...
    \begin{Form}
        ...
        \columnbreak
            % Tooltip object
            \begin{flushright}%
                \PushButton[name=tooltipbtn, bordercolor=]{%
        ...
        \FPeval{\resultW}{(\canvasWidth*3-2)}
            ...
            \begin{flushright}
                \xintFor* #1 in {\xintSeq{0}{\canvasHeight-1}} \do {%
                    \xintFor* #2 in {\xintSeq{0}{\canvasWidth-1}} \do {%
                        \TextField[name=cell#1-#2, bordercolor=, backgroundcolor=,%
                            width=\blocksizeW, height=\blocksizeW, readonly%
                        ]{}%
        ...
        \begin{center}%
            \begin{tabularx}{\textwidth}{@{} *{3}{X} @{}}%
                ...
                \PushButton[name=pause, bordercolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                        Pause\strut
                    \end{tcolorbox}
                } &
                \PushButton[name=resume, bordercolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                        Resume\strut
                    \end{tcolorbox}
