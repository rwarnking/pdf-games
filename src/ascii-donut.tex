...
\begin{document}
    ...
    \begin{Form}
        ...
        \FPeval{\resultW}{(\canvasWidth * 4 + 3)}
        ...
        \begin{tcolorbox}[colback=black]
            %\centering
            \begin{flushright}
            \xintFor* #2 in {\xintSeq{0}{\canvasHeight-1}} \do {%
                \xintFor* #1 in {\xintSeq{0}{\canvasWidth-1}} \do {%
                    \TextField[%
                        width=10pt, height=10pt, bordercolor=white, name=cell#1-#2, readonly=true%
                    ]{}\hspace{3pt}%
                }\vspace{3pt}
                \newline
            }
