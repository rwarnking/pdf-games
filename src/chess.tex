    ...
    \begin{Form}
            ...
            \begin{center}
                ...
                \xintFor* #1 in {\xintSeq{0}{\boardHeight-1}} \do {%
                    \xintFor* #2 in {\xintSeq{0}{\boardWidth-1}} \do {%
                        \TextField[%
                            name=cell#1-#2, width=\blocksize, height=\blocksize,
        ...
        \begin{center}%
            ...
            \begin{tabularx}{\textwidth}{@{} *{2}{X} @{}}%
                \begin{tcolorbox}
                    \TextField[name=moves, width=\linewidth, bordercolor=gray]{}
                \end{tcolorbox} &%
                \PushButton[name=process, bordercolor=, backgroundcolor=, borderwidth=0]{
                    \begin{tcolorbox}
                        \centering
                        Process moves
                        \strut
