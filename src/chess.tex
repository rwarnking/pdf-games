...
function validMove(m, n) {
    ...
    if (equal(cell.borderColor, POSS_MOVE_COLOR)) {
        ...
        printInfoText(complField[lastSelection[M]][lastSelection[N]][PIECE] + " can not move there." + cell.borderColor + " " + POSS_MOVE_COLOR + " " + color.equal(cell.borderColor, POSS_MOVE_COLOR));
        return false;
    }
...
function highlightValidMoves(enable) {
    ...
    % TODO test for check and checkmate
    ...
    if (complField[lastSelection[M]][lastSelection[N]][PIECE] == PIECE_SYMBOLS[PAWN]) {
        ...
        const positions = [
            ...
            % TODO If unmoved allow for a movement of two spaces
            [pieceColor * 2, 0, cellFree]
        ];
