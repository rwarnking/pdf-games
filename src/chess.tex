...
function initialiseButtons() {
    ...
    var funcName = "move";
    for (var m = 0; m < BOARD_WIDTH; m++) {
        for (var n = 0; n < BOARD_HEIGHT; n++) {
...
function addPieces() {
    ...
    complBoard[0][3] = [PIECE_SYMBOLS[QUEEN], BLACK, UNMOVED];
    complBoard[0][4] = [PIECE_SYMBOLS[KING], BLACK, UNMOVED];
    complBoard[BOARD_HEIGHT - 1][3] = [PIECE_SYMBOLS[QUEEN], WHITE, UNMOVED];
    complBoard[BOARD_HEIGHT - 1][4] = [PIECE_SYMBOLS[KING], WHITE, UNMOVED];
}
        ...
        \begin{center}%
            ...
            \begin{tabularx}{\textwidth}{@{} *{4}{X} @{}}%
                \xintFor* #1 in {\xintSeq{0}{3}} \do {%
                    \begin{tcolorbox}
                        \TextField[
                            name=promote#1, width=\linewidth, bordercolor=gray, readonly=true
                        ]{}
                    \end{tcolorbox}
