...
function addPices() {
    % Init pawns
    for (var n = 0; n < FIELD_WIDTH; n++) {
        complField[1][n] = [PICE_SYMBOLS[PAWN], BLACK, UNMOVED];
        complField[FIELD_HEIGHT - 2][n] = [PICE_SYMBOLS[PAWN], WHITE, UNMOVED];
    }

    % Init ROOKS, KNIGHT, BISHOP
    const PICES = [PICE_SYMBOLS[ROOK], PICE_SYMBOLS[KNIGHT], PICE_SYMBOLS[BISHOP]];
    ...
    complField[0][3] = [PICE_SYMBOLS[QUEEN], BLACK, UNMOVED];
    complField[0][4] = [PICE_SYMBOLS[KING], BLACK, UNMOVED];
    complField[FIELD_HEIGHT - 1][3] = [PICE_SYMBOLS[QUEEN], WHITE, UNMOVED];
    complField[FIELD_HEIGHT - 1][4] = [PICE_SYMBOLS[KING], WHITE, UNMOVED];
}
...
function highlightValidMoves(enable) {
    if (complField[lastSelection[M]][lastSelection[N]][PICE] == PICE_SYMBOLS[ROOK]) {
