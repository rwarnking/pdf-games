 ...
 * 3. Setup a array to save which combinations where tried
...
function solveSudoku() {
    ...
    for (var idx = 0; idx < spaces.length && apple < 500000; idx++) {
        ...
        if (!isFieldValid(spaces[idx][0], spaces[idx][1])) {
            ...
            var tmpIdx = idx;
            % For each index that is bigger than the candidates length
            % the next cell should be increased and the last one should
            % be reset to zero. This allows for checking all combinations
