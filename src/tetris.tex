    ...
    \begin{Form}
        ...
        \begin{tcolorbox}
            ...
            \xintFor* #2 in {\xintSeq{0}{\fieldHeight-1}} \do {%
                \xintFor* #1 in {\xintSeq{0}{\fieldWidth-1}} \do {%
                    \TextField[width=\blocksizeW, height=\blocksizeH,
                        bordercolor=white, readonly=true, name=pos#1-#2]{}\hspace{3pt}%
                }\vspace{3pt}
                \newline
            }
            \end{flushright}
        ...
        \begin{center}%
            \begin{tabularx}{\textwidth}{@{} *{3}{X} @{}}%
                ...
                \centering
                \TextField[name=points, width=0.1\textwidth, value=0,
                    bordercolor=white, readonly=true]{Points:} &
                ...
                \PushButton[name=turnLeft, bordercolor=white]{
                    ...
                    \TextField[name=output1, width=0.3\textwidth, height=1.5cm,
                        bordercolor=white, readonly=true]{}
                    %\begin{tcolorbox}
                    %\end{tcolorbox}
                &
