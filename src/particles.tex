...
function moveParticles(idx) {
    ...
    if (particleType == 0) {
        particle.value = String.fromCharCode(particles[idx][2]);
        particle.textSize = PARTICLE_SIZE;
        ...
        particle.value = String.fromCharCode(CIRCLE_SYMBOLS[Math.floor(particles[idx][2] / 3)]);
        particle.textSize = PARTICLE_SIZE + particles[idx][2] * 2;
