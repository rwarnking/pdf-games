...
\begin{document}
    ...
    \begin{Form}
        ...
        \xintFor* #1 in {\xintSeq{0}{\fieldWidth-1}} \do {%
            \PushButton[name=col#1, bordercolor=black]{Col#1}
        }
        ...
        \begin{tcolorbox}
            ...
            \xintFor* #2 in {\xintSeq{0}{\fieldHeight-1}} \do {%
                \xintFor* #1 in {\xintSeq{0}{\fieldWidth-1}} \do {%
                    \TextField[width=1cm, bordercolor=white, name=pos#1#2, readonly=true]{}%
                }\vspace{3pt}
                \newline
            }
            \end{flushright}
