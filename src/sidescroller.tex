...
function refreshObstacles() {
    ...
    for (var i = 0; i < OBSTACLE_COUNT; i++) {
        if (obstacles[i][X] < CANVAS_LTRB[LEFT] && spawn) {
            ...
            var y = getRandomFloat(CANVAS_LTRB[BOT], CANVAS_LTRB[TOP]);
            obstacles[i] = [x, y];
            spawn = false;
        } else {
            const OBSTACLE_MOVE_SPEED = 10;
...
\begin{document}
    ...
    \begin{Form}
        ...
        \begin{center}
            \xintFor* #1 in {\xintSeq{0}{\fieldHeight-1}} \do {%
                \TextField[%
                    ...
                    bordercolor=blue, name=line#1, readonly=true%
                ]{}%
                \\[0pt]%
            }%
        \end{center}
        ...
        \TextField[name=player, width=1cm, height=1cm, bordercolor=red]{}

        \xintFor* #1 in {\xintSeq{0}{\obstacleCount-1}} \do {%
            \TextField[%
                width=1cm, height=1cm,%
                bordercolor=blue, name=obstacle#1, readonly=true%
            ]{}%
        }%
